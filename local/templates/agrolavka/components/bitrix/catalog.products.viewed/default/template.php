...
<section class="home-recent-products catalog-products-viewed" data-entity="<?=$containerName?>">
<h4 class="section-title section-title-h4">Вы смотрели</h4>
	<?
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		<?$rowItems = array_splice($arResult['ITEMS'], 0, 16);?>
				<?
