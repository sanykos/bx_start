				...
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box bx-active">
							...
							<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)"><span class="bx-filter-parameters-box-hint"><i data-role="prop_angle" class="fa fa-angle-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></i> Цена</span></div>
							<div class="bx-filter-block" data-role="bx_filter_block">
								<div class="row bx-filter-parameters-box-container">
									<div class="col-lg-11 col-xl-offset-1 bx-ui-slider-track-container">
									...
									<!-- ***bitrix view price -->
									<!-- custom view price -->
									<div class="col-lg-3 bx-filter-parameters-box">
										<div class="bx-filter-input-container slider-track__val">
											<div class="bx-filter-input-container">
												<div class="bx-filter-price__box d-flex text-gray">
													<span class="minPrice text-gray"
													><?echo $arItem["VALUES"]["MIN"]["HTML_VALUE"]?></span> - 
													<span class="maxPrice text-gray"
													><?echo $arItem["VALUES"]["MAX"]["HTML_VALUE"]?></span><span class="rub text-gray"><i>руб.</i></span>
												</div>
											</div>
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						...
						<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
							<span class="bx-filter-parameters-box-hint"><i data-role="prop_angle" class="fa fa-angle-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></i> <?=$arItem["NAME"]?>
						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								case "A"://NUMBERS_WITH_SLIDER
									?>
									<div class="col-xl-6 bx-filter-parameters-box-container-block bx-left">
									...
									<div class="col-xl-6 bx-filter-parameters-box-container-block bx-right">
									...
									<div class="col-xl-10 col-xl-offset-1 bx-ui-slider-track-container">
										<div class="bx-ui-slider-track" id="drag_track_<?=$key?>">
											<?
											$precision = $arItem["DECIMALS"]? $arItem["DECIMALS"]: 0;
								...
								default://CHECKBOXES
									...
									<div class="col-xl-12">
										<?foreach($arItem["VALUES"] as $val => $ar):?>
											<div class="checkbox">
												<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx-filter-param-label <? echo $ar["DISABLED"] ? 'disabled': '' ?> check option " for="<? echo $ar["CONTROL_ID"] ?>">
													<?//help_arr($ar);?>
													<span class="bx-filter-input-checkbox" data-name="<?=$ar["VALUE"];?>" data-value="<?=$ar["VALUE"]?>">
														<input
															class="check__input"
															type="checkbox"
