...
//help_arr($_SERVER);
?>
	<div class="card card-item card-item__list catalog-item" data-item="<?=$arResult['ITEM']['ID'];?>" id="<?=$arResult['AREA_ID']?>" data-entity="item">
		<div class="card-body">
		<?//help_arr($arResult['ITEM'])?>
			...
			<div class="catalog-price w-100">
				...
				<div class="products-btns">
					...
					<?else:?>
						<strong style="margin-left: 10px;">Цена по запросу</strong>
					<?endif;?>
				</div>
			</div>
		</div>
